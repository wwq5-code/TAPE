...
unl_mib = [0.83887, 0.908837, 0.96457394, 0.975570]

unl_muv = [ 0.839692, 0.9171035, 0.969313, 0.978333]
...
my_y_ticks = np.arange(0.83, 0.991, 0.03)
...
plt.savefig('celeba_rec_sim_lower_bound_analysis.pdf', format='pdf', dpi=200)
plt.show()