...
unl_mib = [0.026143, 0.042585, 0.04727, 0.133360]

unl_muv = [0.03120, 0.048190, 0.05610, 0.1660710]
...
my_y_ticks = np.arange(0, 0.19, 0.03)
...
plt.savefig('celeba_influence_app_lower_bound_analysis.pdf', format='pdf', dpi=200)
plt.show()