...
unl_muv_includes = [0.3100, 0.2073, 0.15, 0.0600, 0.0320, 0.0000]

unl_muv = [0.9943, 0.9867, 0.9583, 0.9583, 0.9490, 0.9497]
...
plt.legend(loc=(0.01,0.35),fontsize=28)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('mnist_verifiability_sample_size_sim_analysis.pdf', format='pdf', dpi=200)
plt.show()