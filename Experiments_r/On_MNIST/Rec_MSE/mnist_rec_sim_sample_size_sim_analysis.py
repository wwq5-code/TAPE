...
unl_mib = [ 0.9459, 0.9097, 0.85268, 0.856668, 0.818231, 0.732786]

unl_muv = [0.96502, 0.93312, 0.9228, 0.915994, 0.903300, 0.902618]
...
plt.savefig('mnist_rec_sim_sample_size_sim_analysis.pdf', format='pdf', dpi=200)
plt.show()