...
unl_mib = [0.13345, 0.134706, 0.1367983, 0.145723, 0.154221, 0.166071]

unl_muv = [0.095646, 0.097062, 0.10083, 0.106176, 0.113739, 0.1235941]
...
plt.savefig('celeba_influence_app_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()