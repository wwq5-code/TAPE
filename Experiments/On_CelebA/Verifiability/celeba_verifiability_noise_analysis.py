...
unl_mib = [0, 0, 0, 0, 0, 0]
unl_mib_bck = [0, 0.7, 0.7, 0.7, 0.7, 0.7]


# unl_hess_r = [96.6, 96.66, 96.04, 95.94, 95.85, 97.21]
unl_muv_includes = [0.2316, 0.5574, 0.8586, 0.9119,  0.9375, 0.9314]

unl_muv = [0.2377, 0.5076,  0.7797, 0.8945, 0.9134,  0.9262]
...
plt.legend(loc=(0.4,0.1),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('celeba_verifiability_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()