...
ax[0,0].bar(x - width / 2,  unl_ss_not_in, width=width / 2, label='SS Not In', color='#F7D58B', edgecolor='black', hatch='*')
ax[0,0].bar(x  , unl_ms_not_in, width=width / 2, label='MS In', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[0,0].set_ylabel('Rec. Similarity', fontsize=16)
...
ax[0,1].bar(x - width / 2,  unl_ss_not_in, width=width / 2, label='SS Not In', color='#F7D58B', edgecolor='black', hatch='*')
ax[0,1].bar(x  , unl_ms_not_in, width=width / 2, label='MS In', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[0,2].bar(x - width / 2,  unl_ss_not_in, width=width / 2, label='SS Not In', color='#F7D58B', edgecolor='black', hatch='*')
ax[0,2].bar(x , unl_ms_not_in, width=width / 2, label='MS In', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[1,0].bar(x - width / 3,  unl_ss_not_in, width=width/3, label='MUA-MD SS', color='#F7D58B', edgecolor='black', hatch='*')
ax[1,0].bar(x  , unl_ms_not_in, width=width/3, label='MUA-MD MS', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[1,0].bar(x + width / 3 , mib_ms_not_in,   width=width/3, label='MIB B-MS', color='#E58579', edgecolor='black', hatch='\\')
...
ax[1,1].bar(x - width / 3,  unl_ss_not_in, width=width/3, label='SS Not In', color='#F7D58B', edgecolor='black', hatch='*')
ax[1,1].bar(x  , unl_ms_not_in, width=width/3, label='MS In', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[1,1].bar(x + width / 3 , mib_ms_not_in,   width=width/3, label='MIB B-MS Not In', color='#E58579', edgecolor='black', hatch='\\')
...
ax[1,2].bar(x - width / 3,  unl_ss_not_in, width=width/3, label='SS Not In', color='#F7D58B', edgecolor='black', hatch='*')
ax[1,2].bar(x  , unl_ms_not_in, width=width/3, label='MS In', color='#B595BF',edgecolor='black', hatch='\\')
...
ax[1,2].bar(x + width / 3 , mib_ms_not_in,   width=width/3, label='MIB B-MS Not In', color='#E58579', edgecolor='black', hatch='\\')
