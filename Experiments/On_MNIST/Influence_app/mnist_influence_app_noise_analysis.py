...
unl_mib = [0.0808, 0.089385, 0.1017479, 0.11422526, 0.145908, 0.1942189]

unl_muv = [0.055564, 0.06047, 0.07330,  0.095581, 0.12741911, 0.17042]
...
plt.savefig('mnist_influence_app_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()