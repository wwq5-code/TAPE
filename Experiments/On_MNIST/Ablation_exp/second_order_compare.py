...
fig, ax = plt.subplots(1, 4, figsize=(20, 3.8)) #sharex='col',
...
leg = plt.legend(fancybox=True, shadow=True)
# plt.xlabel('Malicious Client Ratio (%)' ,fontsize=16)
ax[1].set_ylabel('Rec. Similarity', fontsize=20)
...
leg = plt.legend(fancybox=True, shadow=True)
# plt.xlabel('Malicious Client Ratio (%)' ,fontsize=16)
ax[2].set_ylabel('Verifiability', fontsize=20)
...
#plt.figure(figsize=(8, 5.3))
#plt.plot(x, unl_fr, color='blue', marker='^', label='Retrain',linewidth=l_w, markersize=m_s)
ax[3].plot(x, UEV, linestyle='-', color='#797BB7', marker='o', fillstyle='full', markevery=markevery,
         label='UEV', linewidth=l_w, markersize=m_s, markeredgewidth=marker_s)

#plt.plot(x, unl_ss_w, color='g',  marker='*',  label='PriMU$_{w}$',linewidth=l_w, markersize=m_s)
ax[3].plot(x, UEV_second, linestyle='--', color='#9BC985',  marker='s', fillstyle='full', markevery=markevery,
...
# leg = plt.legend(fancybox=True, shadow=True)
# plt.xlabel('Malicious Client Ratio (%)' ,fontsize=16)
ax[3].set_ylabel('Running Time', fontsize=20)
my_y_ticks = np.arange(100, 180, 15)
ax[3].set_yticks(my_y_ticks )
ax[3].set_xlabel('$\it{ESS}$' ,fontsize=20)

ax[3].set_xticklabels(labels ,fontsize=13)
ax[3].set_xticks(x)
# plt.title('CIFAR10 IID')
