...
unl_mib = [0.97510, 0.97461, 0.975459, 0.976121, 0.976229, 0.977321]

unl_muv = [0.965740, 0.967340, 0.968792, 0.9692447, 0.9698897,  0.97012429]
...
my_y_ticks = np.arange(0.96, 0.98, 0.005)
...
plt.savefig('celeba_rec_mse_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()