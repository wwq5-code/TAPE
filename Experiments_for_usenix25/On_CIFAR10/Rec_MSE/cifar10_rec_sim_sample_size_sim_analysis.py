...
unl_mib = [0.97284, 0.96839, 0.967836, 0.96773, 0.967538, 0.967148]

unl_muv = [0.973764, 0.97290, 0.97248, 0.97214, 0.971333, 0.97083]
...
plt.ylabel('Rec. Similarity' ,fontsize=28)
...
plt.title('On CIFAR10', fontsize=28 )
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('cifar10_rec_sim_sample_size_sim_analysis.pdf', format='pdf', dpi=200)
plt.show()