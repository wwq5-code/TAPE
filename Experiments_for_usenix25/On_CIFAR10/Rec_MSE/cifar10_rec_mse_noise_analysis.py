...
unl_mib = [0.97027, 0.971212, 0.971413, 0.97184, 0.972628, 0.9742451]

unl_muv = [0.96937, 0.96990, 0.9701990, 0.970645, 0.972020, 0.973118]
...
plt.savefig('cifar10_rec_mse_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()