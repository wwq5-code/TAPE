...
unl_mib = [0, 0, 0, 0, 0, 0]
unl_mib_bck = [0, 0.5, 0.95, 0.93, 0.9625, 0.5]

# unl_hess_r = [96.6, 96.66, 96.04, 95.94, 95.85, 97.21]
unl_muv_includes = [0.0708, 0.0628, 0.0304, 0.0356, 0.0320,  0.0388]

unl_muv = [0.9876, 0.9744, 0.9668, 0.9684, 0.9620, 0.9644]
...
plt.plot(x, unl_mib, linestyle='-.', color='#2A5522',  marker='D', fillstyle='full', markevery=markevery,
         label='MIB (GS)',linewidth=l_w, markersize=m_s, markeredgewidth=marker_s)
...
plt.legend(loc=(0.01,0.25),fontsize=28)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('cifar10_verifiability_sample_size_sim_analysis.pdf', format='pdf', dpi=200)
plt.show()