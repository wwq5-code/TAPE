...
#
# ax[0].bar(x - width /5 - width / 5 , UEV, width=width/5, label='TaPD', color='#797BB7', edgecolor='black', hatch='/')
#
# ax[0].bar(x - width / 5 , UEV_no_mask, width=width/5,  label='TaPD w/o UDP', color='#9BC985', edgecolor='black' , hatch='x')
# ax[0].bar(x , UEV_no_division, width=width/5, label='TaPD w/o UID', color='#2A5522', edgecolor='black', hatch='o')
#
#
# ax[0].bar(x + width / 5  , UEV_no_both,   width=width/5, label='TaPD w/o both', color='#E1C855', edgecolor='black',  hatch='\\')

# ax[0].bar(x + width / 6 + width/6 , unl_mib_CIFAR, width=width/6, label='MIB CIFAR10', color='#6BB7CA', edgecolor='black', hatch='*')
#
#
# ax[0].bar(x + width / 6 + width / 6 + width/6  , unl_mib_CelebA,   width=width/6, label='MIB CelebA', color='#E58579', edgecolor='black', hatch='\\')
...
ax[0].set_ylabel('Running Time', fontsize=18)
my_y_ticks = np.arange(60, 162, 20)
...
UEV = [0.9943, 0.9867, 0.9583, 0.9583, 0.9490, 0.9497]
UEV_no_mask = [0.8023, 0.7510, 0.62803, 0.6080, 0.6347, 0.5397]
# unl_hess_r = [96.6, 96.66, 96.04, 95.94, 95.85, 97.21]
UEV_no_division = [0.9717, 0.9267, 0.9377, 0.8097, 0.8643, 0.6703]

UEV_no_both = [0.79790, 0.69293, 0.617603,0.5900, 0.601453, 0.50697]
