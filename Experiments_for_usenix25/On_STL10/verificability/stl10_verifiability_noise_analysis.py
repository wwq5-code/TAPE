...
unl_mib = [0, 0, 0, 0, 0, 0]
unl_mib_bck = [0, 0.7, 1, 1, 1, 1]

# unl_hess_r = [96.6, 96.66, 96.04, 95.94, 95.85, 97.21]
unl_muv_includes = [0.7760, 0.8200, 0.8280, 0.84640,  0.84560, 0.84]

unl_muv = [0.778160, 0.816, 0.8140, 0.81600, 0.8200, 0.8440]
...
plt.savefig('stl10_verifiability_noise_analysis.pdf', format='pdf', dpi=200)
plt.show()